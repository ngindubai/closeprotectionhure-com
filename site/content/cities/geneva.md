---
title: "Geneva"
description: "Close protection and executive security in Geneva. Discreet HNWI protection, diplomatic security and cantonal-licensed operators for UN, WTO and private-banking visitors."
slug: "geneva"
h1: "Close Protection in Geneva, Switzerland"
...
available_services:
  - name: "Bodyguard Hire"
    description: "Discreet, cantonal-licensed close protection officers for HNWI clients, private banking principals, and senior executives visiting Geneva."
  - name: "Executive Protection"
    description: "Full security details for principals attending WTO, WHO, UN Human Rights Council, or other multilateral meetings requiring professional security support."
  - name: "Security Drivers"
    description: "Vetted drivers for Geneva International Airport transfers, city movement, and intercity travel to Zurich, Lausanne, and across the Swiss-French border."
  - name: "Residential Security"
    description: "Security assessment and management for private villas, lakeside properties, and banking district residences."
regulations:
  firearms: "Swiss cantonal law governs private security. Security companies must hold a Brevet Cantonal de gardien-surveillance or equivalent cantonal authorisation. Armed security requires specific cantonal concessions. International operators must comply with Geneva cantonal requirements."
  licensing: "Security companies require cantonal licensing in Geneva under the relevant Geneva cantonal security framework. The regulatory environment is professional and compliance-oriented."
  foreign_operators: "EU-based security companies have some cross-border access under bilateral agreements. Armed security must use Swiss-licensed personnel. All operators working in Geneva must hold current cantonal authorisation."
zones:
  safe:
...
related_cities:
  ...
  - name: "London"
    slug: "london"
faqs:
  - question: "Why is Geneva relevant for close protection despite being one of the world's safest cities?"
    answer: "Geneva's ambient safety statistics reflect the experience of the general population. The principals who require close protection in Geneva are not typical residents -- they are HNWI clients with elevated wealth-targeting risk, senior officials attending UN or WTO negotiations with specific threat profiles, and executives in banking or commodity sectors with commercial adversaries. For these individuals, Geneva's ambient safety is secondary to their specific personal threat assessment."
  - question: "What does close protection look like in Geneva's conservative culture?"
    answer: "Geneva's professional and conservative culture means that effective close protection must be discreet. Visible security draws attention in a city that values privacy and understatement. The best Geneva operators deliver physical presence and professional effectiveness without visual conspicuousness. This requires specific understanding of the city's operational norms and client expectations, which differ from the more visible protective postures appropriate in higher-threat environments."
  - question: "How active is the intelligence environment around UN and WTO meetings in Geneva?"
    answer: "Very active. Multiple countries maintain significant intelligence operations focused on UN system meetings and WTO trade negotiations in Geneva. This includes collection against delegates, officials, and the commercial interests represented in trade negotiations. Counter-intelligence briefing is appropriate for senior officials and executives attending high-stakes Geneva meetings. Communications security -- encrypted messaging, device hygiene, and meeting-room awareness -- is a practical requirement rather than an optional precaution."
  - question: "How do I verify a Geneva cantonal-licensed security operator?"
    answer: "Private security operators in Geneva must hold a valid cantonal authorisation, typically a Brevet Cantonal de gardien-surveillance or equivalent Geneva cantonal certification. Ask for the specific cantonal authorisation reference before any engagement. Armed security requires additional specific cantonal concessions. We provide documentation for all Geneva operators in our network."
  - question: "What security is appropriate for a delegation attending multilateral meetings in Geneva?"
    answer: "For a delegation attending UN, WTO, or similar multilateral meetings, the appropriate baseline includes a close protection officer familiar with Geneva's diplomatic security environment, vetted transport for airport and venue transfers, and counter-intelligence awareness briefing for the specific meeting subject matter. Communications security protocols appropriate to the sensitivity of the negotiations should be reviewed before arrival."
---
...
For the broader Swiss context see our [Zurich city page](/cities/zurich/) and our [London city page](/cities/london/).
