...
risk_level: "high"
seo_title: "Bodyguard Hire Cape Town | Close Protection South Africa"
threats:
  ...
  - type: "Airport Follow-Home Robberies"
  ...
  - type: "Fake Police and Impersonation"
  ...
  - type: "Trail and Outdoor Attacks"
...
available_services:
  - name: "Close Protection"
    description: "PSIRA-licensed close protection officers for personal security in Cape Town. Armed CP is legal and available through Grade A licensed operatives. Available for corporate visits, UHNWI principals, and extended deployments. One of the most operationally intensive CP environments in the P2 city portfolio."
  - name: "Executive Protection"
    description: "Full security details for visiting executives and UHNWI principals. Advance work, counter-surveillance protocols, carjacking contingency planning, and airport arrival management. Armed options available."
  - name: "Security Drivers"
    description: "Trained security drivers with Cape Town route knowledge and counter-surveillance training. Smash-and-grab protected vehicles. Strict airport transfer protocols avoiding the R300 and Borcherd's Quarry Road. All vehicles at a pre-confirmed meeting point with identity verification."
  - name: "Event Security"
    description: "Security planning and staffing for corporate events and private functions in Cape Town. Venue assessment and advance work for the V&A Waterfront, major hotels, and private event spaces."
  - name: "Residential Security"
    description: "Armed response coordination, property security, and guard force management for Cape Town residences. Perimeter security assessment. Immediate response protocols for house robbery incidents."
regulations:
  firearms: "Armed close protection is legal in South Africa and common given the crime environment. Grade A PSIRA-licensed security officers may carry firearms with a valid licence. This is one of the few P2 markets where armed CP for commercial clients is a standard option rather than the exception."
  licensing: "PSIRA (Private Security Industry Regulatory Authority) licenses all private security operators and companies in South Africa. All operatives must hold valid PSIRA registration. Verify PSIRA registration before engaging any operator. The register is publicly verifiable at psira.co.za."
  foreign_operators: "Foreign security operators must work within the PSIRA framework. Overseas principals travelling with home-country CP teams need advance compliance arrangements. South Africa's security industry is one of the world's most developed. Locally licensed PSIRA operators are available at high professional standards."
zones:
  safe:
...
emergency_contacts:
  ...
  - service: "Ambulance"
    number: "10177"
  - service: "Fire (City of Cape Town)"
    number: "021 480 7700"
  - service: "Metro Police"
    number: "021 596 1999"
warnings:
...
related_cities:
  ...
  - name: "Accra"
    slug: "accra"
faqs:
  - question: "Is Cape Town safe for business travel?"
    answer: "Cape Town requires active security management for corporate visitors. OSAC rates crime as CRITICAL. Armed robbery, carjacking, follow-home robberies, and kidnapping are all documented threats. For standard corporate visits with a vetted driver, proper hotel arrangements, and security-aware route planning, the environment is manageable. For UHNWI principals, a full protective detail is the appropriate baseline."
  - question: "What is the airport robbery risk in Cape Town?"
    answer: "Significant. FCDO documents that criminals follow visitors from Cape Town International Airport and rob them at gunpoint. The R300 and Borcherd's Quarry Road are documented ambush corridors. Use only the M3 and N2 for airport access. All airport transport must be pre-booked with a vetted operator. Confirm driver identity before getting in the vehicle."
  - question: "Is armed close protection available in Cape Town?"
    answer: "Yes. South Africa has a well-developed private security industry. PSIRA-licensed Grade A operatives may carry firearms. Armed CP is legal and standard for higher-risk assignments. Given the crime environment, armed protection is a rational option for UHNWI principals and executives with elevated threat profiles."
  - question: "How do I protect against carjacking in Cape Town?"
    answer: "Keep doors locked and windows up while driving at all times. Do not stop in isolated locations. Be alert at traffic lights, petrol stations, and driveways. Use a vetted security driver with counter-carjacking protocols. If confronted: comply. Do not resist."
  - question: "Are the Cape Flats townships safe to visit?"
    answer: "No. Khayelitsha, Gugulethu, and Mitchells Plain have some of the highest crime rates in South Africa. There is no operational justification for a corporate visitor to enter these areas. Township tours are not appropriate for principals with any security concern."
---

Cape Town is one of the world's most striking cities and one of the most operationally intensive close protection environments on the P2 list. Those two facts coexist permanently. Principals attracted by the business opportunity or the environment need to understand both clearly before any visit.
