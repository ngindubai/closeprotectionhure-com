---
title: "Cairo"
description: "Close protection and executive security in Cairo, Egypt. Vetted operators for corporate travel, UHNWI visits, and government engagement in Africa's largest city."
slug: "cairo"
h1: "Close Protection in Cairo"
country: "Egypt"
risk_level: "moderate"
hero_image: "hero.jpg"
...
threats:
  ...
  - type: "Sexual Assault at Resorts"
  ...
  - type: "State Surveillance and Detention Risk"
  ...
  - type: "Road Safety"
    detail: "Cairo road conditions are among the most hazardous in the region. Aggressive driving, poorly marked hazards, and minimal traffic law enforcement make road accidents a significant cause of injury for foreign visitors. A vetted security driver with Cairo route knowledge is the baseline requirement for any serious itinerary."
available_services:
  - name: "Close Protection"
    description: "Locally licensed close protection officers for corporate visitors, government delegations, and HNW principals in Cairo. All operators are vetted through our internal process in addition to Egyptian licensing requirements."
  - name: "Executive Protection"
    description: "Multi-operator security details for C-suite executives conducting business or government engagement in Cairo. Includes advance work, venue assessment, and transport security."
  - name: "Security Drivers"
    description: "Trained drivers with Cairo route knowledge and current awareness of high-risk areas. Private vehicle is the only appropriate transport option for business principals."
  - name: "Event Security"
    description: "Corporate event protection and venue assessment for conferences, business events, and private functions in Cairo and wider Egypt."
  - name: "Residential Security"
    description: "Property security for expatriate accommodation and corporate residences. Guard force management and residential vulnerability assessments."
regulations:
  firearms: "Armed close protection in Egypt is tightly controlled. Private operators are generally unarmed. Government-authorised armed protection exists for diplomatic and senior government-level principals. For most corporate assignments, unarmed CP with Egyptian Police coordination is the standard operating model."
  licensing: "Private security in Egypt is regulated by the Ministry of Interior. All operators require a valid licence. The regulatory framework is enforced and operators without valid documentation carry legal risk for both operator and client."
  foreign_operators: "Foreign security operators require Ministry of Interior authorisation to operate in Egypt. Most international clients use Egyptian-licensed operators or Egyptian-registered partner companies. Bringing an unlicensed foreign operator into Egypt carries legal risk."
zones:
  safe:
...
related_cities:
  ...
  - name: "Nairobi"
    slug: "nairobi"
faqs:
  - question: "Is Cairo safe for business travel?"
    answer: "Cairo is a manageable business destination with the right security arrangements. The central risk for most corporate visitors is not terrorism or violent crime but the legal environment: surveillance, photography restrictions, and the potential for detention over social media activity. A pre-arrival briefing and a vetted security driver throughout the visit are the two most important risk-reduction measures."
  - question: "What laws do I need to know before visiting Egypt?"
    answer: "Photography near military or government infrastructure, including the Suez Canal, is illegal and can result in immediate arrest. Drug possession carries the death penalty or life imprisonment. Drone operation without Ministry of Defence authorisation carries up to seven years in prison. Alcohol is only permitted in licensed establishments. Social media posts criticising the government can trigger detention."
  - question: "Do I need close protection in Cairo?"
    answer: "For most corporate travellers, close protection in Cairo means a vetted security driver and situational awareness support. For UHNWI principals, diplomatic visitors, government-adjacent engagements, or individuals with Israeli connections given the 2023 and 2024 Alexandria shootings, a full CP detail is appropriate."
  - question: "What is the Tourist Police and when should I contact them?"
    answer: "The Tourist Police (126) operates separately from the regular Egyptian Police (122). For incidents involving foreign nationals in tourism-related contexts, the Tourist Police is the first point of contact. For medical emergencies, call Ambulance on 123."
---
