---
title: "Kabul"
description: "Security services in Kabul, Afghanistan. Risk assessment and essential travel security for one of the world's most complex operating environments under Taliban governance."
slug: "kabul"
h1: "Security Assessment: Kabul"
country: "Afghanistan"
risk_level: "critical"
hero_image: "hero.jpg"
parallax_image: "hero.jpg"
threats:
  - type: "Terrorism (Islamic State Khorasan Province)"
  ...
  - type: "No Western Consular Cover"
...
available_services:
  - name: "Risk Assessment"
    description: "Pre-travel assessment for Afghanistan covering current IS-KP activity, route threat levels, Taliban policy environment, and profile-specific risks. Essential before any visit."
  - name: "Bodyguard Hire"
    description: "Afghan close protection through operators with post-2021 operational experience and Taliban relationship management capability. Extremely limited to specific purposes."
  - name: "Security Drivers"
    description: "Vetted Afghan drivers with current Kabul route knowledge, including IED-risk route avoidance and Taliban checkpoint protocols."
  - name: "Executive Protection"
    description: "Available only for specifically assessed assignments. Full threat assessment required before any deployment discussion."
  - name: "Emergency Evacuation Planning"
    description: "Pre-travel evacuation planning covering exit routes, charter flight options, overland alternatives, and border crossing protocols in the event of deteriorating conditions."
regulations:
  firearms: "Afghanistan's security regulatory environment is governed by the Taliban. Armed private security requires Taliban approval. Most established international security companies have withdrawn operations from Afghanistan. The practical regulatory framework is Taliban permission-based rather than a functioning civil licensing system."
  licensing: "There is no functioning civil private security licensing framework in the conventional sense. Afghan security companies that continue operating do so under arrangements with the Taliban. Vetting for Afghanistan requires different criteria than for other markets, including assessment of Taliban relationships and ability to operate without drawing Taliban interference."
  foreign_operators: "Foreign security operators require Taliban approval, which is rarely granted formally. Operations are conducted through local Afghan entities with the appropriate political and tribal relationships. Most Western security companies do not currently operate in Afghanistan outside of very specific contracted international organisation work."
zones:
  safe:
...
emergency_contacts:
  - service: "Taliban Security Forces (ANDSF successor)"
    number: "119"
  - service: "Ambulance (limited functionality)"
    number: "112"
  - service: "Afghan Red Crescent"
    number: "+93 20 220 0317"
  - service: "ICRC Kabul"
    number: "+93 20 250 6001"
warnings:
...
related_cities:
  ...
  - name: "Istanbul"
    slug: "istanbul"
faqs:
  - question: "Is it possible to operate in Kabul at all as a foreign national?"
    answer: "Limited operations continue in Kabul, primarily through international organisations, NGOs operating under Taliban-approved frameworks, and specific development sector activities. These operations typically involve significant security infrastructure, pre-arranged Taliban liaison, and evacuation planning that would not be appropriate for standard corporate travel. For corporate visits, the question is whether the purpose justifies the risk and overhead."
  - question: "What has changed since the Taliban takeover in 2021?"
    answer: "The primary changes for security planning are: withdrawal of Western consular infrastructure, collapse of the Afghan National Security Forces and the pre-existing security regulatory framework, IS-KP's escalation of attacks against civilian and minority targets, and the enforcement of Taliban social restrictions that directly affect female staff and certain visitor profiles. The IED threat has not decreased and IS-KP capability has demonstrated continued sophistication."
  - question: "Can you provide security operators for Afghanistan?"
    answer: "We can identify vetted Afghan operators with post-2021 operational track records and appropriate Taliban relationship management capability for specifically assessed assignments. We require a full brief before any Afghanistan engagement. We do not dispatch operators to Afghanistan without a pre-visit risk assessment, confirmed purpose, emergency evacuation plan, and client acknowledgement of the risk level."
  - question: "What is the IS-KP threat to civilians in Kabul?"
    answer: "Islamic State Khorasan Province (IS-KP) has conducted repeated mass-casualty attacks in Kabul since 2021, targeting minority communities, mosques, education centres, and locations associated with foreign or government activity. The group has demonstrated sustained capability for complex attacks. Any movement plan must treat crowded public locations and predictable gatherings as elevated-risk and minimise time spent at them."
  - question: "What restrictions apply to female staff and visitors in Kabul?"
    answer: "Taliban authorities enforce social restrictions that directly affect women, including requirements around dress, male guardianship (mahram) for certain movements, and access to some workplaces and public spaces. These rules affect the feasibility and planning of any visit involving female personnel, and they can change with limited notice. A current briefing on the prevailing restrictions is essential before travel."
---
