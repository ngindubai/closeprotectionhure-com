...
country: "Singapore"
risk_level: "low"
seo_title: "Bodyguard Hire Singapore | Executive Protection & Close Protection"
threats:
  ...
  - type: "Terrorism (Low but Not Absent)"
  ...
  - type: "Cyber and Corporate Espionage"
  ...
  - type: "Scams and Fraud"
    detail: "Online and phone scams are the most common crime type. Investment fraud, romance scams, and impersonation of government officials are the active methods. Physical theft and violent crime are rare. FCDO confirms violent crime is uncommon."
available_services:
  - name: "Close Protection"
    description: "Locally licensed close protection officers compliant with Singapore's Private Security Industry Act and PLRD requirements. Available for visiting UHNWI, corporate executives, and government delegations."
  - name: "Executive Protection"
    description: "Full security arrangements for C-suite executives visiting Singapore. Includes pre-arrival intelligence assessment, secure transport, and venue advance work."
  - name: "Security Drivers"
    description: "Trained drivers with Singapore road knowledge. Private car arrangements available. MRT is viable for most executive travel but principal preference for private transfer is standard."
  - name: "Event Security"
    description: "Security planning and staffing for corporate events, product launches, and private functions in Singapore. Compliance with PLRD requirements."
  - name: "Residential Security"
    description: "Property security for hotel-based principals and serviced apartment residences. Discreet protection teams suitable for Singapore's security-conscious business environment."
regulations:
  firearms: "Firearms are prohibited for private security in Singapore. All close protection is unarmed. State security services are armed but private operators are not authorised to carry firearms under any circumstances."
  licensing: "The private security industry is regulated under the Private Security Industry Act (Cap 250A) and administered by the Police Licensing and Regulatory Department (PLRD) within the Singapore Police Force. All security officers and managers must be licensed. This includes close protection personnel."
  foreign_operators: "Foreign security officers cannot operate in Singapore without a valid PLRD licence. Overseas principals should confirm that visiting team members hold current Singapore licences or engage locally licensed operators. PLRD licensing is required before commencing any security work, without exception."
zones:
  safe:
...
emergency_contacts:
  - service: "Police (Emergency)"
    number: "999"
  - service: "Ambulance / Fire (Emergency)"
    number: "995"
  - service: "Non-Emergency Police Assistance"
...
related_cities:
  ...
  - name: "Jakarta"
    slug: "jakarta"
faqs:
  - question: "Do I need close protection in Singapore?"
    answer: "For most corporate travellers, Singapore does not require close protection. Physical threat levels are among the lowest of any global city. The case for CP in Singapore is typically driven by principal profile rather than local threat: UHNWI individuals, heads of state, and executives with specific threat assessments may require protection regardless of the local environment. Event security and secure transport are the most common professional security requirements in Singapore."
  - question: "Can my overseas bodyguard work in Singapore?"
    answer: "Not without a valid PLRD licence issued by the Singapore Police Force. There are no exemptions. Foreign nationals working as security officers without a licence face criminal prosecution. We can arrange locally licensed operators at short notice."
