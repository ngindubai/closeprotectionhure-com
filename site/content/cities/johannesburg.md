...
parallax_image: "city-johannesburg-street.jpg"
threats:
  - type: "Carjacking"
  ...
  - type: "Cash-in-Transit Attacks"
    detail: "Organised attacks on cash-in-transit vehicles occur frequently and can put bystanders at risk. These operations involve large criminal groups and military-grade weapons. Distance yourself from cash-in-transit vehicles on the road."
  - type: "Civil Unrest"
...
available_services:
  - name: "Bodyguard Hire"
    description: "Armed and unarmed close protection officers registered with PSIRA South Africa, with documented Johannesburg operational experience."
  - name: "Executive Protection"
    description: "Full executive protection details with armoured vehicles, advance reconnaissance, and contingency planning for carjacking and unrest scenarios."
  - name: "Security Drivers"
    description: "Anti-hijack trained drivers with access to B4 and B6 armoured vehicles across the Johannesburg metro."
  - name: "Residential Security"
    description: "Property security assessment, guard management, CCTV coordination, and armed response integration for executive residences."
regulations:
  firearms: "South Africa's Private Security Industry Regulation Act requires PSIRA registration for all security operators. Armed operators must hold competency certificates under the Firearms Control Act."
  licensing: "All private security operators must be registered with PSIRA (Private Security Industry Regulatory Authority) and hold valid renewal certificates."
  foreign_operators: "Foreign operators must obtain temporary PSIRA registration. In practice, all assignments use locally registered operators with South African security licensing and documented Johannesburg experience."
zones:
  safe:
...
emergency_contacts:
  - service: "Police / Fire / Ambulance"
    number: "10111"
  - service: "Private Ambulance (Netcare)"
    number: "082 911"
  - service: "Private Ambulance (ER24)"
    number: "084 124"
  - service: "SAPS tip-off hotline"
    number: "0800 111 213"
warnings:
...
Our [Johannesburg risk assessment](/risk-assessments/johannesburg/) provides current threat scoring and zone guidance, and the [Johannesburg travel safety guide](/guides/travel-safety-guide-johannesburg/) covers current FCDO advisory status and practical precautions. For operator options, see our [Johannesburg bodyguard hire service](/bodyguard-hire/johannesburg/).
