...
country: "France"
risk_level: "moderate"
seo_title: "Bodyguard Hire Paris | Close Protection France"
threats:
  - type: "Terrorism"
  ...
  - type: "Organised Pickpocket Gangs"
    detail: "Organised criminal networks operate systematic pickpocket operations on the RER B (the main CDG airport rail link), RER D, and busy Metro lines. Approaches include false petitions, the ring scam, and distraction by spilled substances. Luggage theft at Gare du Nord is well-documented. These are professional operations, not opportunistic incidents."
  - type: "Civil Unrest and Industrial Action"
  ...
  - type: "Drink Spiking"
    detail: "GHB drink spiking in Paris bars and nightclubs is a documented risk, particularly in areas catering to tourists. Multiple reports of substances added to drinks, leading to loss of consciousness and subsequent robbery or assault. Nightlife areas frequented by tourists carry elevated exposure."
available_services:
  - name: "Close Protection"
    description: "CNAPS-licensed close protection officers for personal security in Paris and across France. Assignment briefings include current Vigipirate alert levels and operational adjustments."
  - name: "Executive Protection"
    description: "Full security details for C-suite executives and visiting principals. Advance work on venues, hotels, and routes as standard. High-profile business meetings at which intelligence-gathering is a concern receive additional operational security support."
  - name: "Security Drivers"
    description: "Security-trained drivers with Paris knowledge. Pre-booked transfers from CDG, Orly, and Gare du Nord. All operators avoid the high-risk RER B route for executive clients, providing private transfer as standard."
  - name: "Event Security"
    description: "Security planning for corporate events, trade fairs at Paris Le Bourget and Villepinte, and private functions. Vigipirate compliance integrated into event planning."
  - name: "Residential Security"
    description: "Property security for Paris residences and hotel-based principals. Additional discretion measures for ultra-high-net-worth individuals, given France's documented kidnap risk profile for wealthy families."
regulations:
  firearms: "Armed close protection in France requires prefectoral authorisation, which is operationally complex and rarely granted for private assignments. In practice, all private close protection in France is unarmed. Visiting foreign principals with armed protection requirements should plan well in advance and expect significant administrative lead time."
  ...
  foreign_operators: "Foreign close protection officers cannot operate in France without a valid CNAPS card or a formal reciprocal arrangement. Non-compliant operators expose both themselves and the client to legal risk. We ensure all Paris deployments use properly licensed French or CNAPS-compliant operators."
zones:
  safe:
...
related_cities:
  ...
  - name: "Dubai"
    slug: "dubai"
faqs:
  - question: "How serious is the terrorism threat in Paris?"
    answer: "France has experienced more terrorist attacks in the past decade than any other Western European country. The FCDO assesses that further attacks are very likely. The Vigipirate system maintains permanent enhanced security posture at public venues, transport hubs, and places of worship. For corporate travellers, the practical implication is venue unpredictability, extended security screening, and a heightened baseline awareness rather than significant restriction on activity."
  - question: "Is armed protection available in France?"
    answer: "In practice, no. Armed close protection for private clients in France requires prefectoral authorisation, which involves significant administrative process and is rarely granted. All standard private close protection assignments in France are unarmed. Operators focus on conflict avoidance, extraction planning, and surveillance detection."
  - question: "How much does a bodyguard cost in Paris?"
    answer: "A single CNAPS-licensed close protection officer starts from approximately EUR 450-650 per day. Full details with security drivers and advance officers are priced on the assignment scope. Contact us for a confidential quotation."
  - question: "What should I do if there is a transport strike in Paris?"
    answer: "French law requires minimum service notice of 48 hours for transport strikes. However, wildcat industrial action can be shorter-notice. We provide daily transport situation assessments for Paris assignments and maintain alternative routing and private transfer options as standard."
  - question: "Can I take the Metro in Paris with a bodyguard?"
    answer: "For most corporate assignments, private transfer is preferred over Metro use. The Metro carries pickpocket risk on certain lines and RER services. For lower-profile assignments or situations where Metro use is operationally necessary, operators travel in close proximity with awareness of the specific line risk profiles."
---
