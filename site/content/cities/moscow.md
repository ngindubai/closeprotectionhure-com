...
country: "Russia"
risk_level: "high"
hero_image: "city-moscow-hero.jpg"
parallax_image: "city-moscow-street.jpg"
threats:
  - type: "State Detention"
  ...
  - type: "Terrorism"
    detail: "The March 2024 Crocus City Hall attack killed 145 people. IS claimed responsibility. The FCDO rates terrorist attacks in Russia as highly likely. Public gatherings, transport hubs, and entertainment venues are the primary target categories."
  - type: "Surveillance"
    detail: "Extensive state surveillance covers digital and physical environments. The FSB monitors electronic communications. Corporate travellers should treat all hotel rooms, vehicles, and meeting spaces as potentially surveilled."
  - type: "Street Crime"
    detail: "Street crime includes pickpocketing at tourist areas, drink spiking leading to robbery, and criminals posing as police officers. In cold weather, drink spiking can be life-threatening if the victim is left unconscious outside."
available_services:
  - name: "Executive Protection"
    description: "Discreet executive protection with cultural and protocol awareness for the Russian business environment. Russian-licensed operators only."
  - name: "Security Drivers"
    description: "Professional drivers with Moscow route intelligence and security training. Pre-booked transfers from Sheremetyevo and Domodedovo airports."
  - name: "Communications Security Briefing"
    description: "Pre-deployment operational security briefing covering device management and communications discipline for the Russian surveillance environment."
regulations:
  firearms: "Russia's weapons regulations are strict. Private armed security requires specific licensing from the National Guard (Rosgvardiya). Armed protection is available only through licensed Russian operators."
  licensing: "Private security licensed under Federal Law No. 2487-1. Companies require Rosgvardiya registration. Foreign security firms face significant restrictions."
  foreign_operators: "Foreign security operators face significant regulatory barriers in Russia. All practical assignments require Russian-licensed operators. Foreign nationals cannot carry firearms."
zones:
  safe:
...
emergency_contacts:
  ...
  - service: "Universal Emergency"
    number: "112"
  - service: "British Embassy Moscow"
    number: "+7 495 956 7200"
warnings:
...
related_cities:
  ...
  - name: "Kyiv"
    slug: "kyiv"
faqs:
  - question: "Can foreign companies still operate security in Moscow?"
    answer: "Russian-licensed operators meeting our vetting standards remain available. However, the FCDO advises against all travel to Russia and the UK government severely limits consular support. Any engagement of security services in Moscow should be accompanied by current legal advice on sanctions compliance and liability exposure."
  - question: "Is Russia safe for British nationals to travel to?"
  ...
  - question: "What were the Crocus City Hall attacks and what do they mean for corporate security?"
...
Our [detailed risk assessment for Moscow](/risk-assessments/moscow/) covers current threat scoring, zone guidance, and operational protocols. The [FCDO Moscow travel safety guide](/guides/travel-safety-guide-moscow/) provides current advisory status and consular contact details.
