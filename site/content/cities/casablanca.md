---
title: "Casablanca"
description: "Close protection and executive security in Casablanca, Morocco. North Africa's primary commercial centre with a manageable risk profile and specific legal considerations."
slug: "casablanca"
...
threats:
  ...
  - type: "Motorcycle Drive-By Theft"
  ...
  - type: "Counterfeit Spirits"
    detail: "Methanol poisoning from counterfeit alcohol has caused deaths in Morocco. Counterfeit spirits circulate through informal and unlicensed channels. Alcohol should only be consumed at licensed establishments. Methanol poisoning is potentially fatal, not a minor hygiene concern."
  - type: "Seismic Risk"
...
available_services:
  - name: "Close Protection"
    description: "Close protection officers with Casablanca operational experience and current local licensing through our Moroccan partner network."
  - name: "Executive Protection"
    description: "Security details for corporate executives conducting meetings, investor engagements, or multi-site operations across Casablanca and wider Morocco."
  - name: "Security Drivers"
    description: "Trained drivers with Casablanca and Morocco route knowledge. Secure vehicle options available for sensitive assignments."
  - name: "Event Security"
    description: "On-ground security teams for corporate events, private functions, and business gatherings in Casablanca."
  - name: "Residential Security"
    description: "Property security and guard force management for expatriate accommodation and corporate residences in Casablanca."
regulations:
  firearms: "Private armed security is not generally available for commercial assignments in Morocco. The market operates on an unarmed basis. Gendarmerie and police coordination is used for higher-risk assignments requiring armed support."
  licensing: "Morocco's private security sector is regulated through the Ministry of Interior under Law 27-06. All security companies must hold current government licensing. Individual operators require formal accreditation and background verification."
  foreign_operators: "Foreign security operators must partner with a licensed Moroccan security agency. International clients cannot bring in independent foreign operators without compliance arrangements. All assignments are delivered through compliant Moroccan-registered partners."
zones:
  safe:
...
emergency_contacts:
  ...
  - service: "Fire"
    number: "15"
  - service: "UK Embassy Rabat"
    number: "+212-537-633-333"
warnings:
...
related_cities:
  ...
  - name: "Istanbul"
    slug: "istanbul"
faqs:
  - question: "Is Casablanca safe for business travel?"
    answer: "Casablanca is one of the more manageable destinations in this directory. The overall risk rating is low. The primary concerns for business visitors are petty theft in medina areas, the legal environment (strict laws on drugs, alcohol, and personal conduct), and the background terrorism threat. With appropriate operational awareness and a vetted security driver, most corporate itineraries present no significant security challenges."
  - question: "What are the key laws I need to know before visiting Morocco?"
    answer: "Drug possession carries severe sentences. Alcohol is only available at licensed premises. LGBT activity and sex outside marriage are criminal offences. Evangelical materials are illegal. Drone operation requires prior authorisation. Photography of military or government infrastructure should be avoided. These laws apply to all visitors regardless of nationality."
  - question: "Do I need close protection in Casablanca?"
    answer: "For most standard corporate travel, a vetted security driver and operational awareness briefing is sufficient. Close protection becomes appropriate for UHNWI principals, visits involving public-facing events, and itineraries that include medina areas or tourist circuits where the theft risk is higher."
  - question: "Is motorcycle theft a serious risk?"
    answer: "Yes. Drive-by theft targeting handbags and jewellery is documented across Morocco's medina areas. The attack takes seconds and recovery of stolen items is extremely rare. The risk reduction is straightforward: do not carry visible valuables in these areas."
---
