...
threats:
  ...
  - type: "Satellite Phone and GPS Restrictions"
  ...
  - type: "Food and Drink Spiking"
    detail: "FCDO documents cases where British nationals have been robbed or assaulted after accepting food or drinks from strangers. This applies in social settings, at transport hubs, and in apparently reputable venues. Do not accept food or drinks from people you do not know."
  - type: "Road Safety"
...
available_services:
  - name: "Bodyguard Hire"
    description: "PSARA-licensed close protection officers with current Delhi operational knowledge. Available on single-operator and multi-operator details, including female CP officers."
  - name: "Executive Protection"
    description: "Full security details for C-suite executives and visiting principals. Advance work, venue assessment, route planning, and 24-hour coverage available."
  - name: "Security Drivers"
    description: "Trained drivers with Delhi route knowledge and threat-aware vehicle operation. App taxis are an alternative for lower-risk movements; on-street hailing at night is not."
  - name: "Event Security"
    description: "Security planning and staffing for corporate events, investor gatherings, and private functions at Delhi venues."
  - name: "Residential Security"
    description: "Property security for expatriate residences, corporate accommodation, and hotel-based principals in Delhi."
regulations:
  firearms: "Armed private security in India requires state-level permissions under the Arms Act 1959. Armed close protection is practiced for UHNWI, corporate executives, and political principals. All armed operators must hold current state-issued authorisation."
  licensing: "India's private security sector is regulated under the Private Security Agencies (Regulation) Act 2005 (PSARA). State-level licensing is mandatory. Female close protection officers are available and increasingly in demand for assignments involving female principals."
  foreign_operators: "Foreign security operators cannot carry firearms in India. All assignments require Indian-licensed operators or India-registered security companies. International clients work through compliant local partners."
zones:
  safe:
...
related_cities:
  ...
  - name: "Bangkok"
    slug: "bangkok"
faqs:
  - question: "How serious is the terrorism threat in Delhi?"
    answer: "The FCDO rates terrorism in India as very likely, and that assessment applies to Delhi. The city has a lower direct attack history than Mumbai or Kashmir, but it remains a potential target given its political profile, international hotels, and government presence. Security heightens around Republic Day (26 January), Independence Day (15 August), Diwali, and Eid. Itinerary planning should factor this in."
  - question: "What security provision is appropriate for a female executive visiting Delhi?"
    answer: "The FCDO specifically documents sexual assault risk for female foreign nationals in India. For female principals, a security detail including at least one female close protection officer is the appropriate baseline. Solo movement after dark is not advisable under any circumstances. All movement outside the secure districts (Lutyens, Aerocity, South Delhi) should be planned and accompanied."
  - question: "Can I bring my satellite phone to Delhi?"
    answer: "Not without a licence. Satellite phones and GPS devices are illegal in India without authorisation from the Department of Telecommunications. British nationals have been arrested for carrying these devices. Standard mobile phones on Indian GSM networks are not affected. Check all kit before departure."
  - question: "Is close protection available for corporate visits to Delhi?"
    answer: "Yes. India has a developed private security sector under PSARA (2005), with licensed operators and a range of capability levels available in Delhi. Armed close protection is available for higher-risk profiles. Contact us for a confidential assessment."
---

Delhi is India's capital and one of its largest cities. It draws corporate delegations, diplomatic visits, government-sector business, and an increasing volume of technology and financial services travel. The FCDO and US State Department both advise heightened vigilance. That advice is warranted.
