---
title: "Shanghai"
description: "Security services in Shanghai, China. Executive protection, legal risk management, and secure transport for corporate travel to China's financial capital."
slug: "shanghai"
h1: "Executive Protection in Shanghai"
country: "China"
risk_level: "low-moderate"
hero_image: "hero.jpg"
parallax_image: "hero.jpg"
threats:
  - type: "Exit Bans and National Security Law Detention"
  ...
  - type: "Bar and Nightclub Drug Raids"
  ...
  - type: "Internet and Communications Restrictions"
...
available_services:
  - name: "Executive Protection"
    description: "Close protection and executive security for visiting principals in Shanghai. Operations subject to Chinese regulatory requirements including Ministry of Public Security approval."
  - name: "Security Drivers"
    description: "Vetted Shanghai drivers with knowledge of Pudong and Puxi geography. Pre-booked transfers from Pudong International Airport and Hongqiao Airport."
  - name: "Legal Risk Briefing"
    description: "Pre-travel legal risk assessment covering national security law exposure, commercial dispute red flags, and communications security for China visits."
  - name: "Residential Security"
    description: "Property security for expatriate assignments and extended principal stays in Puxi and Pudong districts."
  - name: "Event Security"
    description: "Corporate event security and venue assessment for business conferences and private functions in Shanghai."
regulations:
  firearms: "Private armed security for foreign nationals is not generally available in China without specific government approval. The domestic security industry is state-regulated. Armed close protection for visiting foreign executives requires advance coordination through official channels."
  licensing: "Private security in China is regulated by the Ministry of Public Security. Foreign security companies cannot operate directly without joint venture arrangements with Chinese entities. In practice, most executive security support for visiting foreigners operates through vetted transport, hotel security infrastructure, and advance planning."
...
emergency_contacts:
  ...
  - service: "Fire"
    number: "119"
  - service: "British Consulate-General Shanghai"
...
related_cities:
  ...
  - name: "Tokyo"
    slug: "tokyo"
faqs:
  - question: "Is Shanghai different from Beijing in terms of security risk?"
    answer: "The legal risk framework is identical: the same national security laws apply, the same exit ban powers exist, and the same 99% conviction rate applies across all Chinese courts. Physical crime risk is comparably low in both cities by global standards. Shanghai's bar and nightclub scene is more prominent than Beijing's, which creates a higher practical exposure to police drug raid operations for corporate visitors who attend evening social events."
  - question: "What should I know about the drug raid risk?"
    answer: "Chinese police conduct unannounced drug raids in bars and nightclubs. Everyone present is tested, not only individuals suspected of drug use. A foreign national who entered the venue for a business dinner or corporate reception faces the same testing as any other person in the building. Testing positive leads to detention, fines, and deportation. Being aware of which venues carry higher enforcement risk is part of pre-travel security planning for Shanghai."
  - question: "How do I communicate securely in Shanghai?"
    answer: "You largely cannot, using standard tools. WhatsApp, Google, Signal, and most Western communications platforms are blocked or restricted. More importantly, China's telecommunications infrastructure should be treated as a state surveillance environment. Sensitive business discussions should be avoided on any electronic medium while in China. Advance planning, including preparation of necessary information before travel and use of in-person communication for sensitive matters, is the operational approach."
  - question: "Can my close protection team operate in Shanghai?"
    answer: "Foreign close protection operators face the same regulatory restrictions in Shanghai as in Beijing. Ministry of Public Security approval is required for private security operations involving non-Chinese nationals. We have experience in advising on the operational constraints and can arrange appropriate security support through approved channels. Contact us well in advance of your travel dates."
---
