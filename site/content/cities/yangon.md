---
title: "Yangon"
description: "Close protection and security services in Yangon, Myanmar. Security drivers, executive protection, and residential security for NGO staff, corporate visitors, and energy sector personnel following the 2021 military coup."
slug: "yangon"
h1: "Close Protection in Yangon, Myanmar"
country: "Myanmar"
risk_level: "high"
hero_image: "geralt-watch-10184898.jpg"
seo_title: "Close Protection in Yangon, Myanmar | Security Services & Bodyguard Hire Post-Coup"
threats:
  - type: "Military Coup and Civil Conflict"
  ...
  - type: "Armed Crime and Civil Disorder"
    detail: "Armed robberies, carjackings, and security force checkpoints create a volatile ground-level environment. The breakdown of rule of law since the coup has increased opportunistic crime in Yangon. Unannounced military checkpoints create unpredictability in movement."
available_services:
  - name: "Executive Protection"
    description: "Close protection for senior NGO directors, energy sector principals, and humanitarian coordination staff who have essential operations requiring presence in Yangon."
  - name: "Security Drivers"
    description: "Vetted security drivers with current knowledge of Yangon's checkpoint patterns, high-risk routes, and the rapidly changing security environment. Essential for all movement."
  - name: "Residential Security"
    description: "Security assessment and hardening for NGO compound and expatriate residences, including protocols for lockdown and emergency extraction."
  - name: "Risk Assessment"
    description: "Pre-deployment risk assessments for organisations considering or maintaining operations in Myanmar, covering the current conflict status, NGO operating environment, and detention risk factors."
regulations:
  firearms: "Myanmar's firearms regulations have effectively broken down in many areas outside Yangon following the coup. In Yangon, the SAC military maintains armed presence throughout the city. Private security is heavily restricted under the junta. International security operators face significant legal and practical constraints."
  licensing: "The SAC military government controls all security-related licensing. The pre-coup regulatory framework has been effectively replaced by junta control. International security companies must navigate significant legal ambiguity."
  foreign_operators: "Foreign security operations in Myanmar post-coup operate in a fundamentally different legal environment from pre-2021. Any security operations must be carefully evaluated for legal exposure, potential association with sanctioned entities, and the risk of junta scrutiny."
zones:
  safe:
...
emergency_contacts:
  - service: "Emergency (nominally)"
    number: "199"
  - service: "UK Embassy Yangon"
    number: "+95 1 380 322"
  - service: "US Embassy Rangoon"
    number: "+95 1 753 6509"
warnings:
...
related_cities:
  ...
  - name: "Kathmandu"
    slug: "kathmandu"
faqs:
  - question: "Should organisations continue operations in Myanmar after the 2021 coup?"
