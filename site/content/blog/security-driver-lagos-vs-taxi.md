...
tags:
  ...
  - "ground-transport"
faqs:
  - question: "Is it safe to use Uber in Lagos?"
    answer: "Uber operates in Lagos and is generally safer than hailing a street taxi, but it is not without risk. Incidents involving Uber drivers have been reported in Lagos, and the platform does not apply the same vetting standards as a professional security driver service. For executives, senior management, or anyone who has been publicly identified or operates in a sector with kidnapping risk, a vetted security driver is a significant upgrade in risk management over a general ride-hailing app."
  - question: "What is the kidnapping risk in Lagos for business travellers?"
    answer: "The UK FCDO rates Nigeria as a country with a high kidnapping risk, with specific warnings for Lagos. The threat is primarily from criminal gangs targeting perceived wealth rather than politically motivated groups, though both exist in Nigeria more broadly. Business travellers staying in Ikoyi, Victoria Island, or Lekki and moving through the city in unvetted vehicles are visible targets. The risk is not uniform: it concentrates on certain routes, certain times, and certain profiles."
  - question: "What is a security driver in Lagos and what do they do differently?"
    answer: "A professional security driver in Lagos is not simply a driver with a clean record. They are trained in threat recognition, evasive and defensive driving, route planning and route alternatives, anti-surveillance awareness, and first aid. They conduct advance reconnaissance of routes. They operate in vehicles that do not advertise value. They know which roads to avoid at which times and have protocols for approaching and leaving venues. They are in contact with an operations controller throughout the assignment."
  - question: "Which routes in Lagos carry the highest transport risk?"
    answer: "The Third Mainland Bridge has been the site of armed robbery incidents. Oshodi and parts of Mushin carry elevated crime risk. Night movement outside the Ikoyi and Victoria Island corridor significantly increases exposure. The Lagos-Ibadan Expressway outside the city has seen kidnapping incidents involving vehicles stopping or being forced to stop. Professional security drivers know these risk factors and plan routes accordingly."
  - question: "How much does a security driver cost in Lagos?"
    answer: "Day rates for a vetted security driver in Lagos, including a secure vehicle, typically start from USD 300 to USD 500 per day for a standard engagement. Armed escort vehicles, specialist vehicles, or multi-vehicle convoys are priced separately. Compared to the cost of an interrupted business trip or a kidnap response, this represents a low-cost risk mitigation measure."
  - question: "Does a security driver in Lagos also provide close protection?"
    answer: "A security driver and a close protection officer are different roles. A security driver's primary function is the safe movement of the principal by vehicle. A close protection officer provides personal security at venues, during meetings, and in situations where the principal is on foot. For a comprehensive security package in Lagos, both functions are often deployed together: a driver for ground movement, a CPO for venue and foot security."
---
