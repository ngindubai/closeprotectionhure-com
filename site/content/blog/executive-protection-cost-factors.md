...
|---------------|-------------|
| Security driver only | Low-risk environment, routine business travel |
| 1 CPO + security driver | Standard business travel in medium-risk cities |
| 2 CPOs + driver | Higher-risk environments, high-profile principals |
| Lead CPO + team + ops support | Complex programmes, multiple venues, elevated threat |
...
For the specific service configurations available through this platform, see our [executive protection service page](/services/executive-protection/) and [bodyguard hire](/services/bodyguard-hire/) overview.
