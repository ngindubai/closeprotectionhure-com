...
faqs:
  ...
  - question: "Do individual high-profile athletes need personal close protection separate from team security?"
    answer: "Some do. Athletes with specific threat profiles (documented stalking, credible threats, high social media following that generates confrontation) may require personal protection beyond what team security provides. This is particularly relevant for athletes who spend significant time in public away from team environments (sponsors, personal appearances, social events), where team security does not extend."
  - question: "How should sports teams manage security on high-risk away fixtures?"
    answer: "Teams travelling to higher-risk destinations benefit from advance work on venues, hotels, and transport, secure and well-timed movement between airport, hotel, and stadium, and coordination with local authorities and the host club. The travelling party's predictability is the main vulnerability to manage."
  - question: "Do individual high-profile athletes need protection beyond team security?"
    answer: "High-profile athletes can attract crowding, fixation, and occasional threats that team-level arrangements do not fully cover, which sometimes justifies individual close protection. The decision follows the athlete's profile and any specific threat rather than a blanket rule."
---
