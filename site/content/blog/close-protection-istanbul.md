...
faqs:
  ...
  - question: "Do I need a security driver in Istanbul?"
    answer: "For senior executives, a vetted security driver for airport transfers and significant city movement is appropriate given Istanbul's complex geography, traffic environment, and the terrorism threat. For standard business visitors at lower risk levels, a reputable taxi or Uber equivalent (BiTaksi is widely used) is adequate for most movements."
  - question: "What is the risk at Istanbul's airports?"
    answer: "Istanbul's main international airports are Istanbul Airport (IST) on the European side and Sabiha Gokcen (SAW) on the Asian side. Istanbul Airport is one of the world's largest and has extensive security infrastructure following the 2016 Ataturk Airport attack. Pre-arranged transfer from a known provider reduces exposure at the airport and on the E80 motorway into the city."
  - question: "How does Istanbul's location affect the threat picture?"
...
For the detail on what OGG certification involves, what armed security authorisation requires, and what restrictions apply to foreign security personnel, our [Turkey private security regulations guide](/blog/private-security-regulations-turkey/) covers the full framework.
...
For full service details in Istanbul, see our [Istanbul city page](/cities/istanbul/) and [executive protection service overview](/services/executive-protection/).
