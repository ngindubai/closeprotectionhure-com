...
seo_title: "How to Vet a Close Protection Company | CloseProtectionHire.com"
tags:
  - "executive-protection"
  - "vetting"
  - "corporate-security"
faqs:
  - question: "What licences should a close protection company hold in the UK?"
    answer: "In England and Wales, all close protection officers must hold a current Security Industry Authority (SIA) Close Protection licence. The company itself should hold an SIA Approved Contractor Scheme (ACS) status, which confirms ongoing compliance with training, vetting, and operational standards. Working with unlicensed operators creates legal exposure for the buyer."
  - question: "How do I verify an SIA licence is genuine?"
    answer: "The SIA maintains a public licence-checking portal at services.sia.homeoffice.gov.uk. Enter the licence number and the name on the licence. A valid licence shows the current status, expiry date, and the specific activities it covers. Request the licence number from any operator before engaging them."
  - question: "Should a close protection company carry professional indemnity insurance?"
    answer: "Yes. Professional indemnity insurance covers errors and omissions in the security planning process. Public liability insurance covers third-party injury or property damage arising from security operations. Employers liability is required by law if the company employs staff. Ask for certificates of currency for all three before signing any contract."
  - question: "What vetting standard should close protection officers meet?"
    answer: "At minimum: SIA licence (confirming criminal records check, identity verification, and training). Better operators apply BS 7858 vetting (the British Standard for security personnel screening), which includes 5-year employment history verification, financial probity checks, and character references. For high-risk principals, ask for operators vetted to BPSS (Baseline Personnel Security Standard) or SC (Security Check) level."
  - question: "What is the difference between a close protection company and a security guarding company?"
    answer: "A security guarding company provides static and mobile guards for premises and events. Close protection is a specialist discipline requiring different training, qualifications, and operational mindset. The SIA issues separate licence categories for each. A guarding company should not be providing close protection unless its officers hold current SIA CP licences and the company has relevant operational experience."
---
...
For the service context behind this checklist, see our [executive protection service overview](/services/executive-protection/) and the [about page](/about/) for information on how CloseProtectionHire.com vets the operators in its network.
