---
title: "Bodyguard Hire in Kabul"
description: "Close protection in Kabul under Taliban governance. Specialist operators with post-2021 Afghanistan experience, IS-KP threat awareness, and Taliban liaison capability."
slug: "kabul"
h1: "Bodyguard Hire in Kabul, Afghanistan"
seo_title: "Bodyguard Hire Kabul | Close Protection Afghanistan"
...
cta_text: "Request a Kabul Security Consultation"
components:
  - title: "IS-KP and Complex Attack Assessment"
    description: "Islamic State Khorasan Province has conducted mass-casualty attacks in Kabul since August 2021, including the HKIA airport bombing that killed approximately 170 people. Every operational plan accounts for the IS-KP complex attack threat, not just street-level crime."
  - title: "Taliban Liaison and Authorisation"
    description: "All security operations in Afghanistan require Taliban approval. Operators without established Taliban liaison channels cannot function in Kabul. We work with vetted local Afghan firms whose principals have navigated the post-2021 regulatory environment and maintain the relationships necessary for legitimate operations."
  - title: "Post-2021 Local Operators"
    description: "Western security companies have largely withdrawn from Afghanistan. Credible local operators are Afghan firms whose senior personnel operated during and after the August 2021 transition, understand Taliban administrative processes, and have verifiable references from international humanitarian and commercial clients active in country."
  - title: "No Consular Safety Net"
    description: "Most Western embassies have closed or suspended consular services in Kabul. There is no diplomatic safety net for foreign nationals in difficulty. Protection planning must account for self-contained medical, legal, and evacuation contingencies without relying on consular assistance."
  - title: "Kidnap and Arbitrary Detention Protocols"
    description: "The kidnap risk in Kabul extends beyond criminal actors to include Taliban arbitrary detention of foreign nationals. Operators must have protocols for both criminal and administrative detention scenarios, with legal and liaison contacts available at short notice."
  - title: "Movement and Accommodation Security"
    description: "All movements in Kabul require advance work, hardened vehicles, and communication protocols. Guesthouse and compound security assessments are mandatory prior to occupancy. Pattern-of-life analysis and low-profile movement discipline are foundational to any Kabul security plan."
faqs:
  - question: "Can Western nationals still travel to Kabul?"
    answer: "Travel is physically possible but the FCDO advises against all travel to Afghanistan, and the US State Department has issued a Level 4 Do Not Travel advisory. No Western embassy provides consular services in Kabul. Organisations sending personnel to Kabul must operate on a self-sufficient basis, with medical, legal, and evacuation planning that does not depend on government assistance."
  - question: "How does the Taliban affect private security operations?"
    answer: "The Taliban is now the governing authority in Afghanistan and all security operations require their approval. Security companies operating without Taliban authorisation face arbitrary detention of staff and clients. Working with operators who have established Taliban liaison channels is not optional: it is the operational baseline."
  - question: "What is the IS-KP threat in Kabul specifically?"
    answer: "Islamic State Khorasan Province has conducted multiple mass-casualty attacks in Kabul since 2021, targeting crowded locations, checkpoints, and foreign-presence sites. The HKIA airport attack in August 2021 killed approximately 170 people. IS-KP continues to conduct complex attacks using suicide bombers and IEDs. Security planning must treat mass-casualty attack as a primary threat, not a background risk."
  - question: "Are there reliable close protection operators still working in Kabul?"
    answer: "Yes, but the operator landscape has changed fundamentally since 2021. Credible options are Afghan firms whose principals operated through the transition, understand Taliban administrative requirements, and hold references from humanitarian organisations or commercial clients with verified Kabul operations. We assess operators against these criteria before any introduction."
  - question: "What happens if a client needs medical evacuation from Kabul?"
...
For clients whose work requires presence in Afghanistan, our [Kabul city security overview](/cities/kabul/) provides the full threat assessment context. Organisations that need both close protection and secure ground movement should review our [security drivers in Kabul](/security-drivers/kabul/) service, as the airport corridor and inter-district movement both require specialist driver and route planning.
