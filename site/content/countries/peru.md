---
title: "Peru"
description: "Security services in Peru. Close protection and secure transport for Lima from SUCAMEC-licensed operators. Armed CP available. Pre-travel assessment recommended."
slug: "peru"
h1: "Security Services in Peru"
risk_level: "high"
hero_image: "hero.jpg"
regulations:
  firearms: "Armed private security is legal in Peru and widely practiced. SUCAMEC (Superintendencia Nacional de Control de Servicios de Seguridad, Armas, Municiones y Explosivos de Uso Civil) licenses both private security companies and individual armed operatives. Many Peruvian CPOs have military or national police backgrounds. Armed close protection is the market standard for corporate clients at elevated risk levels. Foreign nationals may not independently carry firearms: all armed operations must be through SUCAMEC-licensed Peruvian operators or Peruvian-licensed companies."
  licensing: "SUCAMEC is the licensing authority for all private security activity in Peru. Company registration, individual operator licensing, and weapons permits are all administered through SUCAMEC. Annual renewal is required. The regulatory framework is more formalised than much of the region. Verifying current SUCAMEC registration status before deploying any Peru operator is standard practice."
  foreign_operators: "Foreign security companies must operate through SUCAMEC-licensed Peruvian entities. International advisors can work in advisory roles but armed operation requires Peruvian licensing. Pre-deployment regulatory confirmation is required for any mixed international and local team structure."
cities:
  - name: "Lima"
    slug: "lima"
    risk_level: "high"
    summary: "Peru's capital and commercial centre. Armed robbery at gunpoint is documented in Miraflores and Barranco, districts typically considered higher quality residential and business areas. Express kidnapping operates at Jorge Chavez International Airport using fake taxis. Civil unrest periodically blocks infrastructure. Methanol deaths in counterfeit spirits are a documented risk for visiting travellers."
faqs:
  - question: "Why is there a risk at Jorge Chavez Airport specifically?"
    answer: "Jorge Chavez International Airport has been identified by FCDO and OSAC as a location where express kidnapping via fake taxis operates. The methodology involves individuals posing as legitimate taxi drivers approaching arriving passengers. Victims are driven to ATMs and required to make cash withdrawals. The counter-measure is straightforward: pre-arrange airport pickups with a verified operator, do not accept any approach from individuals offering transport at the arrivals hall, and use only pre-booked vehicles. This eliminates the most common crime vector at Lima airport."
  - question: "Is Miraflores safe for corporate travellers?"
    answer: "Miraflores and Barranco are Lima's most affluent districts and the location of most international hotels used for corporate travel. They carry lower risk than many other Lima districts. Armed robbery at gunpoint has been documented in both areas, including incidents on streets adjacent to hotels. This does not mean Miraflores is unsuitable for business travel. It means that personal security awareness, vetted transport, and avoiding isolated pedestrian movement after dark are appropriate precautions even in Lima's highest-quality districts."
  - question: "What is the civil unrest risk in Peru?"
    answer: "Peru has experienced recurring cycles of civil unrest since the 2022 political crisis triggered by the removal of President Castillo. Protests, roadblocks, and infrastructure shutdowns have affected Lima and major transit routes. Unrest can materialise with limited warning. Corporate travellers should include contingency transport planning in any Peru itinerary, particularly for airport transfers, and monitor local alerts in the 24-48 hours before any road movement."
---
