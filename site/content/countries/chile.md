---
title: "Chile"
description: "Security services in Chile. Close protection and secure transport for Santiago from RNGDS-licensed operators. Mining sector CP standard. Protest calendar awareness required."
slug: "chile"
...
regulations:
  ...
  licensing: "RNGDS is administered by the Ministerio del Interior y Seguridad Publica. Company registration and individual operator licensing are both required. The system is formalised and compliance is verifiable. Annual renewals are required for individual licences. Verifying RNGDS status before deploying any Chile operator is straightforward given the centralised registry."
  foreign_operators: "Foreign security companies must operate through Chilean-registered entities. International advisors can work in advisory and planning roles. Armed operations require RNGDS licensing. The extractive sector in Chile has established norms for international security advisor deployment, which provide a practical framework for mixed-team structures."
cities:
  - name: "Santiago"
    slug: "santiago"
    risk_level: "medium"
...
faqs:
  ...
  - question: "What is the tyre puncture scam?"
    answer: "The tyre puncture scam targets rental car users on roads surrounding Santiago and on routes to airports. An accomplice punctures a tyre, then the same individual or associates offer to help with the change. During the distraction, valuables in the vehicle are stolen. Countermeasures include: not stopping at unusual roadside locations, driving to a petrol station or public space before addressing a tyre issue, and keeping doors locked and valuables out of sight at all times in vehicles."
  - question: "Which dates carry the highest protest risk in Santiago?"
    answer: "Several annual dates carry elevated protest risk in Santiago: 11 September (anniversary of the 1973 coup), 29 March (Young Combatant Day), and 1 May (Workers Day) regularly produce significant street protests with a history of violence in the city centre and Providencia. Friday protests around the Plaza Baquedano area have been a recurring pattern since the 2019 estallido social. Itineraries involving Santiago on these dates should include revised routing, hotel selection away from protest corridors, and flexibility in ground transport plans."
---
