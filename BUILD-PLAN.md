...
| 06 Jul 2026 | Batch38 (5 blocks) | 50 | Block 1: RS x 10 batch28 cities (Bologna, Genoa, Malaga, Zaragoza, Rennes, Bordeaux, Eindhoven, Utrecht, Ghent, Nantes). Block 2: ES x same 10. Block 3: CPO x same 10. Block 4: SAT x same 10 -- closes the matrix gap, all 7 services now cover all 278 pre-batch29 cities. Block 5: City expansion batch29 (10 new cities: Palma de Mallorca/Spain, Montpellier/France, Lille/France, Strasbourg/France, Dusseldorf/Germany, Stuttgart/Germany, Leipzig/Germany, Bremen/Germany, Liege/Belgium, Antwerp/Belgium). Cities live: 288. QA: 0 errors across all 50 pages (python3 scripts/qa_audit.py, 0 errors site-wide across 2,425 pages). Total: 2,325 pages live. |
